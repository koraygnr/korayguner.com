...
function Projects() {
  ...
  return (
    <div className='container flex flex-col space-y-6 justify-between max-w-7xl mx-auto py-20'>
      <div className='flex justify-between items-center w-full pb-4 border-b border-primary-dark'>
        ...
        <button>
          <span className='flex items-center gap-2 text-primary-purple font-semibold'>
